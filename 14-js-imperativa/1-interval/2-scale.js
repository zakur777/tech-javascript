...
// TODO : Mejorar writeline "repite codigo" 
...
console.writeln(`El intervalo [${minInterval},${maxInterval}] con factor de escala ${scale} es el intervalo [${midPoint - length / 2 * scale},${midPoint + length / 2 * scale}]`);