...
const sumNumerator = numerator1 * denominador2 + numerator2 * denominador1;
const commonDenominator = denominador1 * denominador2;

console.writeln(`\nLa suma de la fracción ${numerator1}/${denominador1} y la fracción ${numerator2}/${denominador2} es la fracción ${sumNumerator}/${commonDenominator}`);