...
console.writeln(`\nLa multiplicación de la fracción ${numerator1}/${denominador1} y la fracción ${numerator2}/${denominador2} es la fracción ${numerator1*numerator2}/${denominador1*denominador2}`);